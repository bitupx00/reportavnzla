...
const ENDPOINTS: Endpoint[] = [
  ...
  { method: 'POST', path: '/v1/check-duplicate', auth: true, params: 'file | image_url, min_score?', desc: 'Foto → ¿ya hay una persona registrada con ese rostro? Acepta file, URL http o data-URI base64; cualquier formato.' },
  { method: 'POST', path: '/v1/search', auth: true, params: 'file | image_url, min_score?', desc: 'Foto → personas más parecidas (top-10) con score y source. Acepta file, URL http o data-URI. Busca en TODAS las bases.' },
